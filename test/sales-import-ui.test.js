...
function harness(overrides={},uiOptions={}){
 ...
 const context=vm.createContext({document,setTimeout,clearTimeout});vm.runInContext(fs.readFileSync(path.join(__dirname,'../public/sales-import-ui.js'),'utf8'),context);
